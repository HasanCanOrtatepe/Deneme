package com.etiya.notificationservice.config;
 ...
 * Cache values are serialized as JSON (Jackson, java.time support built in — needed here for the
 * {@code Instant} fields) instead of JDK serialization, so response DTOs don't need to implement
 * Serializable.
 */
@Configuration
@EnableCaching
