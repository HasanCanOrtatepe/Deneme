package com.etiya.cartservice.messaging;

import com.etiya.cartservice.customers.CustomerReplica;
import com.etiya.cartservice.customers.CustomerReplicaRepository;
import com.etiya.cartservice.events.CustomerEvent;
import com.etiya.cartservice.inbox.InboxMessage;
import com.etiya.cartservice.inbox.InboxRepository;
 ...
 * pattern).
 *
 * <p>The whole method runs in one transaction: the inbox checkpoint and the replica change commit
