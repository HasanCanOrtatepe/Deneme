...
public class OutboxService {
     ...
     *
     * @param aggregateType domain aggregate, e.g. {@code "Cart"}
     * @param aggregateId   aggregate instance id, e.g. the cart id
     * @param eventType     logical event name, e.g. {@code "CartCheckedOut"}
