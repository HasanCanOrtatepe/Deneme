 ...
 * before the row is committed as published, the next poll re-sends it. Consumers must therefore be
 * idempotent (see the Inbox pattern in notification-service).</p>
 *
