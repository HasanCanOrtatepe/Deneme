 ...
 * publishing to Kafka directly, so the message is durably queued in the same transaction as the
 * domain change and later relayed by {@link OutboxMessageRelay}.
 */
@Service
public class OutboxService {
     ...
     *
     * @param aggregateType domain aggregate, e.g. {@code "Customer"}
     * @param aggregateId   aggregate instance id, e.g. the customer id
     * @param eventType     logical event name, e.g. {@code "CustomerCreated"}
